"""
Cloudflare Bypass API using Playwright
"""
import asyncio
...
async def tmonkey_bypass(url: HttpUrl):
    try:
        async with async_playwright() as p:
            ...
            # Wait for Cloudflare JS challenge to solve itself
            await page.wait_for_timeout(8000)

            # Inject Tampermonkey script code here
            tampermonkey_code = """
            (function() {
            'use strict';
            ...
            """
            result = await page.evaluate(tampermonkey_code)
